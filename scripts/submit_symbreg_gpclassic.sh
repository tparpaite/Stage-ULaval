...
#PBS -m bea
#PBS -o $HOME/Stage-ULaval/scripts/outputs/gpclassic_%I.out
#PBS -e $HOME/Stage-ULaval/scripts/outputs/gpclassic_%I.err
...
./array_job_symbreg_gpclassic.sh $MOAB_JOBARRAYINDEX &
