...
#PBS -m bea
#PBS -o $HOME/Stage-ULaval/scripts/outputs/tfhugegraph_bis_%I.out
#PBS -e $HOME/Stage-ULaval/scripts/outputs/tfhugegraph_bis_%I.err
...
./array_job_tensorflow_huge_graph.sh $MOAB_JOBARRAYINDEX &
