...
#PBS -m bea
#PBS -o $HOME/Stage-ULaval/scripts/outputs/gpharm_urg_%I.out
#PBS -e $HOME/Stage-ULaval/scripts/outputs/gpharm_urg_%I.err
...
./array_job_gpharm_urg.sh $MOAB_JOBARRAYINDEX &
