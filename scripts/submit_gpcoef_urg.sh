...
#PBS -m bea
#PBS -o $HOME/Stage-ULaval/scripts/outputs/gpcoef_urg_%I.out
#PBS -e $HOME/Stage-ULaval/scripts/outputs/gpcoef_urg_%I.err
...
./array_job_gpcoef_urg.sh $MOAB_JOBARRAYINDEX &
