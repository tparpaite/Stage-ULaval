...
#PBS -m bea
#PBS -o $HOME/Stage-ULaval/scripts/outputs/linear_%I.out
#PBS -e $HOME/Stage-ULaval/scripts/outputs/linear_%I.err
...
./array_job_symbreg_linear.sh $MOAB_JOBARRAYINDEX &
